...
class Config(object):
    ...
    # AWS SNS topics
    AWS_SNS_JOB_THAW_TOPIC = (
        f"arn:aws:sns:us-east-1:127134666975:{iam_username}_a{HW}_job_thaw"
    )

    AWS_SNS_JOB_RESTORE_TOPIC = (
        f"arn:aws:sns:us-east-1:127134666975:{iam_username}_a{HW}_job_restore"
    )

    # AWS SQS queues
    AWS_SQS_WAIT_TIME = 20
    AWS_SQS_MAX_MESSAGES = 10
    AWS_SQS_THAW_QUEUE_NAME = (
        f"https://sqs.us-east-1.amazonaws.com/127134666975/{iam_username}_a{HW}_job_thaw"
    )
